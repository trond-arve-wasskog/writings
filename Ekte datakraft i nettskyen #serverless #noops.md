...
* _CaaS - Containers-as-a-Service_ betegner typisk Docker-containere som abstraksjon for utrulling av applikasjoner, og tilbyr gjerne orkestrering av clustere, tjenesteoppslag, lastbalansering, _fail-over_ og liknende funksjonalitet. _CaaS_ kan ses på som en mellomting mellom virtualisering med IaaS og PaaS. [Kubernetes](https://kubernetes.io/) er den mest kjente orkestreringsplattformen, og tre store nettskyleverandørene tilbyr [Google Container Engine](https://cloud.google.com/container-engine/), [Azure Container Service](https://azure.microsoft.com/en-us/services/container-service/)  [Amazon EC2 Container Service](https://aws.amazon.com/ecs/).
